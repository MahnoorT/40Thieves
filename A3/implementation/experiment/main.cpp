...
int main() {
  ...
  std::cout << "t0: suit: " << board.get_tab(0).top().s << " rank: " << board.get_tab(0).top().r << std::endl;
  std::cout << "t1: suit: " << board.get_tab(1).top().s << " rank: " << board.get_tab(1).top().r << std::endl;
  std::cout << "t2: suit: " << board.get_tab(2).top().s << " rank: " << board.get_tab(2).top().r << std::endl;
  std::cout << "t3: suit: " << board.get_tab(3).top().s << " rank: " << board.get_tab(3).top().r << std::endl;
  std::cout << "t4: suit: " << board.get_tab(4).top().s << " rank: " << board.get_tab(4).top().r << std::endl;
  std::cout << "t5: suit: " << board.get_tab(5).top().s << " rank: " << board.get_tab(5).top().r << std::endl;
  std::cout << "t6: suit: " << board.get_tab(6).top().s << " rank: " << board.get_tab(6).top().r << std::endl;
  std::cout << "t7: suit: " << board.get_tab(7).top().s << " rank: " << board.get_tab(7).top().r << std::endl;
  std::cout << "t8: suit: " << board.get_tab(8).top().s << " rank: " << board.get_tab(8).top().r << std::endl;
  std::cout << "t9: suit: " << board.get_tab(9).top().s << " rank: " << board.get_tab(9).top().r << std::endl;
